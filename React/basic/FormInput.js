    ...
    return (
        <div>
            ...
            <table ALIGN="center" border="1">
                ...
                <tr>
                    <td colSpan="2" ALIGN="center">
                        {/* onClick={onClick}에서 {onClick}에서 onClick처럼 괄호가 없는 겨우는
                    위에서 정의한 화살표 함수가 저장된 변수를 나타내며 함수 호출 형식이 아니기
                    때문에 자동으로 호출되지 않는다. */}
            ...
            <table ALIGN="center" border="1">
                ...
                {memberList}
                {/* 이벤트 함수를 호출할 때 함수명()으로 호출하는 경우 랜더링될 때
                자동으로 한번은 호출되므로 반드시 화살표 함수로 기술해야 한다.
                그렇지 않은 경우 무한 루프에 빠지거나 의도하지 않는 수행을 하는 상황이
                발생한다. */}
            </table>
            <hr />
        </div>
